...
このドキュメントは、医療AIプラットフォームのシステム提案資料を作成するためのプロンプト集です。
...
- EKS (Fargate): Kubernetes 1.33 (2026-05時点の EKS 標準サポート対象)
...
| 項目 | 正しい値 | よくある間違い |
|------|---------|---------------|
| Kubernetes版 | 1.33 (2026-05時点 EKS 標準サポート) | 1.28 以下 (既に標準サポート外) |
