# スマートシティ向けAIアプリケーション インフラ設計書

## 1. 概要

### 1.1 目的

本設計書は、ウーブン・バイ・トヨタ株式会社のスマートシティ向けAIアプリケーションにおけるインフラ構成、Kubernetes環境、データ処理パイプライン、CI/CDパイプラインの設計方針を定義します。

### 1.2 システム概要

スマートシティ向けAIアプリケーションは、都市データを収集・分析し、AI技術を活用して最適化された都市運営を実現するプラットフォームです。
