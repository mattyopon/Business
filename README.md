...
│   └── 技術検証/            # 技術デモプロジェクト
│
├── ANK-未割当-金融AWS共通基盤/  # 金融機関 AWS クラウド共通基盤 要件定義/基本設計
│   ├── 商談用/              # 商談・面談資料
│   ├── 参画用/              # 参画後の設計・運用ドキュメント
│   └── 技術検証/            # 技術デモプロジェクト
│
...
| 案件番号 | 業種 | 概要 |
|---------|------|------|
| [ANK0000639199](./ANK0000639199/) | 医療IT | 医療AIプラットフォームのインフラ構築 |
| [ANK0000640318](./ANK0000640318/) | 金融 | 金融決済プラットフォーム基盤運用 |
| [ANK0000642825](./ANK0000642825/) | 検索システム | 検索システムインフラ構築支援 |
| [ANK-未割当-金融AWS共通基盤](./ANK-未割当-金融AWS共通基盤/) | 金融 | 金融機関向けクラウド共通基盤 要件定義・基本設計支援 |
