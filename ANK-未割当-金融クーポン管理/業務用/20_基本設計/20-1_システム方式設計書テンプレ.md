...
| # | 構成要素 | 概要 | AWS サービス候補 |
|---|---|---|---|
| 1 | API ゲートウェイ | 別チャネル (社内 NW) からの内部リクエスト受付 | API Gateway / ALB |
...
- ALB (Internal Only (本案件は完全プライベート業務系のため Internet-facing 不使用)) → ECS Service (API)
